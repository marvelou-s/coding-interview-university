...
> Я начал с того, что написал небольшой спиок тем для изучения, чтобы стать инженером-программистом,
...
>
> Накопленный материал отлично подготовит Вас к собеседованию в практически любую компанию,
...
**Оригинал:** [English](https://github.com/jwasham/coding-interview-university/blob/master/README.md)
...
## <a name="why-use-it"></a> Зачем учиться новому?
...
которую я когда-либо использовал была встроена в возможности языка программирования, и я не представлял как они
вообще работают. Мне никогда не доводилось работать с памятью. Я искал решение только если процесс, который
...
## <a name="how-to-use-it"></a> Как этим пользоваться?

Все, что представленно ниже - учебный план. Изучайте материал шаг за шагом, сверху вниз.

Я пользуюсь специальным языком разметки - Markdown. С его помощью можно создавать списки задач, чтобы контроллировать
процесс обучения.
